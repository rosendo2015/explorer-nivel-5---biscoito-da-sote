const CoockAberto = document.querySelector(".aberto");
const CoockFechado = document.querySelector(".fechado");
...
function generatePhrase() {
  CoockFechado.classList.toggle("hide");
  CoockAberto.classList.toggle("hide");

  gerarPhrases = Math.floor(Math.random() * phrases.length);

  sorte.innerText = phrases[gerarPhrases];
}
